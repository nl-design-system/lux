...
const LuxIcon = ({ icon, children }) => {
  ...
  fill: currentColor;
    ...
    icon !== void 0 ? icon : /* @__PURE__ */ jsxRuntimeExports.jsx(FallbackIcon, {}),
    children
  ] });
};
...
export {
  ...
  LuxParagraph as i,
  LuxDocument as j,
  LuxFormFieldCheckbox as k,
  LuxFormFieldDescription as l,
  LuxFormFieldErrorMessage as m,
  LuxFormFieldLabel as n,
  LuxFormFieldRadioGroup as o,
  LuxFormFieldRadioOption as p,
  LuxFormFieldSelect as q,
  LuxFormFieldTextbox as r,
  LuxFormField as s,
  LuxHeading2 as t,
  LuxHeading3 as u,
  LuxHeading4 as v,
