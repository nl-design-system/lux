...
var lodash_clonedeepwith = { exports: {} };
lodash_clonedeepwith.exports;
(function(module, exports) {
  var LARGE_ARRAY_SIZE = 200;
  var HASH_UNDEFINED = "__lodash_hash_undefined__";
  var MAX_SAFE_INTEGER = 9007199254740991;
  var argsTag = "[object Arguments]", arrayTag = "[object Array]", boolTag = "[object Boolean]", dateTag = "[object Date]", errorTag = "[object Error]", funcTag = "[object Function]", genTag = "[object GeneratorFunction]", mapTag = "[object Map]", numberTag = "[object Number]", objectTag2 = "[object Object]", promiseTag = "[object Promise]", regexpTag = "[object RegExp]", setTag = "[object Set]", stringTag = "[object String]", symbolTag = "[object Symbol]", weakMapTag = "[object WeakMap]";
  ...
  var Buffer = moduleExports ? root.Buffer : void 0, Symbol = root.Symbol, Uint8Array = root.Uint8Array, getPrototype2 = overArg2(Object.getPrototypeOf, Object), objectCreate = Object.create, propertyIsEnumerable = objectProto2.propertyIsEnumerable, splice = arrayProto.splice;
  var nativeGetSymbols = Object.getOwnPropertySymbols, nativeIsBuffer = Buffer ? Buffer.isBuffer : void 0, nativeKeys = overArg2(Object.keys, Object);
...
})(lodash_clonedeepwith, lodash_clonedeepwith.exports);
var lodash_clonedeepwithExports = lodash_clonedeepwith.exports;
const cloneDeepWith = /* @__PURE__ */ getDefaultExportFromCjs(lodash_clonedeepwithExports);
...
const isPlainObject$1 = /* @__PURE__ */ getDefaultExportFromCjs(lodash_isplainobject);
var lodash_mapvalues = { exports: {} };
lodash_mapvalues.exports;
(function(module, exports) {
  var LARGE_ARRAY_SIZE = 200;
  ...
  var Symbol = root.Symbol, Uint8Array = root.Uint8Array, propertyIsEnumerable = objectProto2.propertyIsEnumerable, splice = arrayProto.splice;
...
})(lodash_mapvalues, lodash_mapvalues.exports);
var lodash_mapvaluesExports = lodash_mapvalues.exports;
const mapValues = /* @__PURE__ */ getDefaultExportFromCjs(lodash_mapvaluesExports);
var lodash_omitby = { exports: {} };
lodash_omitby.exports;
(function(module, exports) {
  var LARGE_ARRAY_SIZE = 200;
  var FUNC_ERROR_TEXT = "Expected a function";
  var HASH_UNDEFINED = "__lodash_hash_undefined__";
  ...
  var Symbol = root.Symbol, Uint8Array = root.Uint8Array, getPrototype2 = overArg2(Object.getPrototypeOf, Object), propertyIsEnumerable = objectProto2.propertyIsEnumerable, splice = arrayProto.splice;
  var nativeGetSymbols = Object.getOwnPropertySymbols, nativeKeys = overArg2(Object.keys, Object);
  var DataView = getNative(root, "DataView"), Map = getNative(root, "Map"), Promise2 = getNative(root, "Promise"), Set = getNative(root, "Set"), WeakMap = getNative(root, "WeakMap"), nativeCreate = getNative(Object, "create");
  var dataViewCtorString = toSource(DataView), mapCtorString = toSource(Map), promiseCtorString = toSource(Promise2), setCtorString = toSource(Set), weakMapCtorString = toSource(WeakMap);
  var symbolProto = Symbol ? Symbol.prototype : void 0, symbolValueOf = symbolProto ? symbolProto.valueOf : void 0, symbolToString = symbolProto ? symbolProto.toString : void 0;
  function Hash(entries) {
...
})(lodash_omitby, lodash_omitby.exports);
var lodash_omitbyExports = lodash_omitby.exports;
const omitBy = /* @__PURE__ */ getDefaultExportFromCjs(lodash_omitbyExports);
const createVisualRegressionStory = (render, options = {}) => {
...
VisualRegressionWrapper.__docgenInfo = { "description": "Create an HTML flex container so every visual regression story has the same layout\n\nUse together with #createVisualRegressionStory\n\n@see {@link createVisualRegressionStory} on how to use it\n@param props {@link React.PropsWithChildren}\n@returns A {@link React.ReactElement}", "methods": [], "displayName": "VisualRegressionWrapper", "props": { "className": { "required": true, "tsType": { "name": "string" }, "description": "" } } };
export {
  VisualRegressionWrapper as V,
  cloneDeepWith as a,
  createVisualRegressionStory as c,
