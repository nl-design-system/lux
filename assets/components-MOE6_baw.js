...
const tokens = [
  ...
  {
    parent: "button login/default",
    type: "color",
    value: "#282828",
    description: "",
    filePath: "src/imported/component/button login.json",
    isSource: false,
    original: {
      parent: "button login/default",
      type: "color",
  ...
  },
  {
    ...
    original: {
      parent: "button login/default",
      type: "color",
      value: "{mode.button-login.active.background-color}",
      description: ""
    },
    name: "background-color",
    attributes: {},
  ...
  },
  {
    ...
    isSource: false,
    original: {
      value: "{lux.link.active.tex-decoration}",
      type: "textDecoration"
    },
    name: "tex-decoration",
    attributes: {},
...
const LuxButtonLogin = /* @__PURE__ */ createReactComponent("lux-button-login");
