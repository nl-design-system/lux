  ...
  (function(e, n) {
    ...
    function or() {
      return {
        ...
        JsdocTypeVariadic: /* @__PURE__ */ r((t, o) => t.meta.position === void 0 ? "..." : Ie(t.meta.position, o(t.element), "..."), "JsdocTypeVariadic"),
        ...
        JsdocTypeObject: /* @__PURE__ */ r((t, o) => `{${t.elements.map(o).join((t.meta.separator === "comma" ? "," : ";") + " ")}}`, "JsdocTypeObject"),
...
const { UnknownArgTypesError: np } = __STORYBOOK_MODULE_CORE_EVENTS_PREVIEW_ERRORS__;
var cr = /^['"]|['"]$/g, tp = /* @__PURE__ */ r((e) => e.replace(cr, ""), "trimQuotes"), rp = /* @__PURE__ */ r((e) => cr.test(e), "includesQuotes"), ke = /* @__PURE__ */ r((e) => {
  let n = tp(e);
...
const { UnknownArgTypesError: ap } = __STORYBOOK_MODULE_CORE_EVENTS_PREVIEW_ERRORS__;
var ip = /* @__PURE__ */ r((e) => e.name === "literal", "isLiteral"), sp = /* @__PURE__ */ r((e) => e.value.replace(/['|"]/g, ""), "toEnumOption"), pp = /* @__PURE__ */ r((e) => {
  switch (e.type) {
    case "function":
      return { name: "function" };
    case "object":
...
r(_m, "compactJoiner");
var Dm = /* @__PURE__ */ r((e, { tokens: n }, a) => n.type === "" ? e : a, "lineNo"), qm = /* @__PURE__ */ r(({ tokens: e }) => (e.delimiter === "" ? e.start : e.postDelimiter.slice(1)) + e.description, "getDescription");
function Im(e, n = F) {
  if (e.length === 0)
    return "";
...
const { combineParameters: iT } = __STORYBOOK_MODULE_PREVIEW_API__;
var zw = /* @__PURE__ */ r((e) => {
  let {
    component: n,
    argTypes: a,
...
var ms = "storybook/docs", eP = `${ms}/snippet-rendered`, sT = /* @__PURE__ */ ((s) => (s.AUTO = "auto", s.CODE = "code", s.DYNAMIC = "dynamic", s))(sT || {});
export {
  $w as $,
  Bw as B,
  Ht as H,
