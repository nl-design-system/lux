...
const DigidButton = class {
  ...
  render() {
    return h("div", { key: "e2a357b9b6a819e67310ceb89b4fa3dee69b9b2f", class: "utrecht-logo-button" }, h("slot", { key: "7d76821bfa58b392694dbea3d917b50edb94401f" }));
  }
};
DigidButton.style = UtrechtLogoButtonStyle0;
export {
  DigidButton as utrecht_logo_button
};
