...
const MultilineData = class {
  ...
  render() {
    return h("pre", { key: "431cb18c6e7c59c2dee7c3e724284bd9249260ba", class: "utrecht-multiline-data utrecht-multiline-data--html-pre" }, h("slot", { key: "8a1464265d9b4af3242ed7247d97fed3a35cba17" }));
  }
};
MultilineData.style = UtrechtMultilineDataStyle0;
export {
  MultilineData as utrecht_multiline_data
};
