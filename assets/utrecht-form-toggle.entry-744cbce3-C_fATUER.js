import { a as registerInstance, d as createEvent, b as h } from "./preview-Bv8JVllW.js";
...
const FormToggle = class {
  ...
  render() {
    ...
    return h("div", { key: "e50441d494eea0dbf949283b820877e147991c37", class: clsx("utrecht-form-toggle", checked && "utrecht-form-toggle--checked", !checked && "utrecht-form-toggle--not-checked", disabled && "utrecht-form-toggle--disabled"), tabIndex: disabled ? null : 0, role: "switch", "aria-disabled": disabled ? "true" : null, onClick: handleClick, onKeyPress: handleKeyPress, onKeyUp: handleKeyUp }, h("div", { key: "1a76a11c72929e64aaf12a3ed1d39aefbbaddb77", class: "utrecht-form-toggle__label utrecht-form-toggle__label--off" }), h("div", { key: "f4eb9f79800f1b3527e3033a4b8fa9401dd7b3ba", class: "utrecht-form-toggle__label utrecht-form-toggle__label--on" }), h("div", { key: "8a6aa7345bd182f1e654f1c40a4b8654e35fa6c3", class: clsx("utrecht-form-toggle__track", checked && "utrecht-form-toggle__track--checked", !checked && "utrecht-form-toggle__track--not-checked", disabled && "utrecht-form-toggle__track--disabled") }, h("div", { key: "557e5340e6489e1a14667ec000fc4cc9130441c9", class: clsx("utrecht-form-toggle__thumb", checked && "utrecht-form-toggle__thumb--checked", !checked && "utrecht-form-toggle__thumb--not-checked", disabled && "utrecht-form-toggle__thumb--disabled") })));
  }
};
FormToggle.style = UtrechtFormToggleStyle0;
export {
  FormToggle as utrecht_form_toggle
};
