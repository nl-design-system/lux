...
import { d as LuxButtonLogin$1, t as tokens, c as createDesignTokensStory } from "./components-MOE6_baw.js";
...
const VisualAgents = () => /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
  ...
  /* @__PURE__ */ jsxRuntimeExports.jsx(LuxButtonLogin$1, { agent: "digid" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx(LuxButtonLogin$1, { agent: "digid-machtigen" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx(LuxButtonLogin$1, { agent: "eherkenning" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx(LuxButtonLogin$1, { agent: "eidas" })
] });
...
const VisualStates = () => /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
  ...
  /* @__PURE__ */ jsxRuntimeExports.jsx(LuxButtonLogin$1, { agent: "digid", label: "Hover", class: "force-state--hover" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx(LuxButtonLogin$1, { agent: "digid", label: "Active", class: "force-state--active" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx(LuxButtonLogin$1, { agent: "digid", label: "Focus", class: "force-state--focus" })
] });
VisualStates.__docgenInfo = { "description": "", "methods": [], "displayName": "VisualStates" };
const LuxButtonLogin = (props) => /* @__PURE__ */ jsxRuntimeExports.jsx(LuxButtonLogin$1, { ...props });
const meta = {
...
const ButtonLoginStories = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  DarkTheme,
  DesignTokens,
  LightTheme,
