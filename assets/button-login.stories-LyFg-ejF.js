import{j as s}from"./jsx-runtime-CKrituN3.js";import{R as v,r as z}from"./index-CBqU2yxZ.js";import"./_commonjsHelpers-BosuxZz1.js";const T=e=>e.toLowerCase().split("-").map(n=>n.charAt(0).toUpperCase()+n.slice(1)).join(""),L=e=>e.replace(/([A-Z])/g,n=>`-${n[0].toLowerCase()}`),V=(e,n,i={})=>{if(e instanceof Element){const o=D(e.classList,n,i);o!==""&&(e.className=o),Object.keys(n).forEach(t=>{if(!(t==="children"||t==="style"||t==="ref"||t==="class"||t==="className"||t==="forwardedRef"))if(t.indexOf("on")===0&&t[2]===t[2].toUpperCase()){const l=t.substring(2),a=l[0].toLowerCase()+l.substring(1);S(a)||G(e,a,n[t])}else e[t]=n[t],typeof n[t]==="string"&&e.setAttribute(L(t),n[t])})}},D=(e,n,i)=>{const o=n.className||n.class,t=i.className||i.class,l=k(e),a=k(o?o.split(" "):[]),c=k(t?t.split(" "):[]),g=[];return l.forEach(r=>{a.has(r)?(g.push(r),a.delete(r)):c.has(r)||g.push(r)}),a.forEach(r=>g.push(r)),g.join(" ")},P=e=>{switch(e){case"doubleclick":return"dblclick"}return e};/**
 * Checks if an event is supported in the current execution environment.
 * @license Modernizr 3.0.0pre (Custom Build) | MIT
 */const S=e=>{if(typeof document>"u")return!0;{const n="on"+P(e);let i=n in document;if(!i){const o=document.createElement("div");o.setAttribute(n,"return;"),i=typeof o[n]=="function"}return i}},G=(e,n,i)=>{const o=e.__events||(e.__events={}),t=o[n];t&&e.removeEventListener(n,t),e.addEventListener(n,o[n]=function(a){i&&i.call(this,a)})},k=e=>{const n=new Map;return e.forEach(i=>n.set(i,i)),n},H=(e,n)=>{typeof e=="function"?e(n):e!=null&&(e.current=n)},I=(...e)=>n=>{e.forEach(i=>{H(i,n)})},U=(e,n)=>{const i=(o,t)=>v.createElement(e,Object.assign({},o,{forwardedRef:t}));return i.displayName=n,v.forwardRef(i)};var B=function(e,n){var i={};for(var o in e)Object.prototype.hasOwnProperty.call(e,o)&&n.indexOf(o)<0&&(i[o]=e[o]);if(e!=null&&typeof Object.getOwnPropertySymbols=="function")for(var t=0,o=Object.getOwnPropertySymbols(e);t<o.length;t++)n.indexOf(o[t])<0&&Object.prototype.propertyIsEnumerable.call(e,o[t])&&(i[o[t]]=e[o[t]]);return i};const F=(e,n,i,o)=>{o!==void 0&&o();const t=T(e),l=class extends v.Component{constructor(a){super(a),this.setComponentElRef=c=>{this.componentEl=c}}componentDidMount(){this.componentDidUpdate(this.props)}componentDidUpdate(a){V(this.componentEl,this.props,a)}render(){const a=this.props,{children:c,forwardedRef:g,style:r,className:Q,ref:Z}=a,y=B(a,["children","forwardedRef","style","className","ref"]);let m=Object.keys(y).reduce((h,u)=>{const x=y[u];if(u.indexOf("on")===0&&u[2]===u[2].toUpperCase()){const p=u.substring(2).toLowerCase();typeof document<"u"&&S(p)&&(h[u]=x)}else{const p=typeof x;(p==="string"||p==="boolean"||p==="number")&&(h[L(u)]=x)}return h},{});i&&(m=i(this.props,m));const _=Object.assign(Object.assign({},m),{ref:I(g,this.setComponentElRef),style:r});return z.createElement(e,_,c)}static get displayName(){return t}};return n&&(l.contextType=n),U(l,t)},d=F("lux-button-login"),M=`Biedt de mogelijkheid om naar de beschikbare inlogmiddelen te navigeren.
...
## Playground
`,N=()=>s.jsxs(s.Fragment,{children:[s.jsx("h4",{className:"lux-heading-4",children:"Agents"}),s.jsx(d,{agent:"digid"}),s.jsx(d,{agent:"digid-machtigen"}),s.jsx(d,{agent:"eherkenning"}),s.jsx(d,{agent:"eidas"})]});N.__docgenInfo={description:"",methods:[],displayName:"VisualAgents"};const O=()=>s.jsxs(s.Fragment,{children:[s.jsx("h4",{className:"lux-heading-4",children:"States"}),s.jsx(d,{agent:"digid",label:"Hover",class:"force-state--hover"}),s.jsx(d,{agent:"digid",label:"Active",class:"force-state--active"}),s.jsx(d,{agent:"digid",label:"Focus",class:"force-state--focus"})]});O.__docgenInfo={description:"",methods:[],displayName:"VisualStates"};const X=e=>({parameters:{options:{showPanel:!1},a11y:{disable:!0},interactions:{disable:!0},actions:{disable:!0},controls:{disable:!0},backgrounds:{default:"transparent"},chromatic:{disable:!1,disableSnapshot:!1}},render:e}),W=({children:e})=>{const n={backgroundColor:"",display:"flex",flexDirection:"column",flexWrap:"wrap",gap:"16px 32px"};return s.jsx("div",{style:n,children:e})};W.__docgenInfo={description:`Create an HTML flex container so every visual regression story has the same layout
...
@returns A {@link React.ReactElement}`,methods:[],displayName:"VisualRegressionWrapper"};const $=e=>s.jsx(d,{...e}),Y={title:"Web Components/Button login",id:"web-components-button-login",component:$,argTypes:{label:{type:"string"},agent:{options:["digid","digid-machtigen","eherkenning","eidas"],control:{type:"select"}}},tags:["autodocs"],parameters:{docs:{description:{component:M}}}},f={name:"Playground",args:{label:"",agent:"digid"}},b=X(()=>s.jsxs(W,{children:[s.jsx(N,{}),s.jsx(O,{})]}));b.__docgenInfo={description:"",methods:[],displayName:"Visual"};var j,w,R;f.parameters={...f.parameters,docs:{...(j=f.parameters)==null?void 0:j.docs,source:{originalSource:`{
  name: 'Playground',
  args: {
    label: '',
    agent: 'digid'
  }
}`,...(R=(w=f.parameters)==null?void 0:w.docs)==null?void 0:R.source}}};var C,A,E;b.parameters={...b.parameters,docs:{...(C=b.parameters)==null?void 0:C.docs,source:{originalSource:`createVisualRegressionStory(() => <VisualRegressionWrapper>
    <VisualAgents />
    <VisualStates />
  </VisualRegressionWrapper>)`,...(E=(A=b.parameters)==null?void 0:A.docs)==null?void 0:E.source}}};const ee=["Playground","Visual"];export{f as Playground,b as Visual,ee as __namedExportsOrder,Y as default};
