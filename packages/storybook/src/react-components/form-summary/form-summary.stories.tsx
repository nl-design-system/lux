...
const meta = {
  title: 'React Components/FormSummary',
  id: 'react-components-form-summary',
  component: LuxFormSummary,
  subcomponents: {},
  parameters: {
    badges: [BADGES.STABLE, BADGES.LATEST],
    tokens,
    tokensPrefix: 'utrecht-form-summary',
  },
  argTypes: {
    children: {
      name: 'content',
...
} satisfies Meta<typeof LuxFormSummary>;
