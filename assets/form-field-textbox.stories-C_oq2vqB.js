...
import { r as LuxFormFieldTextbox } from "./index-DzCBCR8w.js";
...
import { m as meta$2 } from "./form-field-description.stories-W2kfN2xM.js";
import { m as meta$3 } from "./form-field-error-message.stories-CDbQeU5U.js";
import { m as meta$1 } from "./textbox.stories-C2aIY4qz.js";
const VisualStates = () => /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
  /* @__PURE__ */ jsxRuntimeExports.jsx(LuxFormFieldTextbox, { label: "Label" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx(LuxFormFieldTextbox, { label: "Label", description: "Description" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx("h5", { className: "utrecht-heading-4", children: "Hover & Focus" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pseudo-hover-all", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LuxFormFieldTextbox, { label: "Label" }) }),
  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pseudo-focus-all pseudo-focus-visible-all", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LuxFormFieldTextbox, { label: "Label" }) }),
  /* @__PURE__ */ jsxRuntimeExports.jsx("h5", { className: "utrecht-heading-4", children: "Invalid" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx(LuxFormFieldTextbox, { label: "Label", errorMessage: "Error Message", invalid: true }),
  /* @__PURE__ */ jsxRuntimeExports.jsx(LuxFormFieldTextbox, { label: "Label", description: "Description", errorMessage: "Error Message", invalid: true }),
  /* @__PURE__ */ jsxRuntimeExports.jsx("h5", { className: "utrecht-heading-4", children: "Disabled" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx(LuxFormFieldTextbox, { label: "Label", disabled: true }),
  /* @__PURE__ */ jsxRuntimeExports.jsx(LuxFormFieldTextbox, { label: "Label", description: "Description", disabled: true })
] });
