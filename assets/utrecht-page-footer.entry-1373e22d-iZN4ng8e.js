...
const PageFooter = class {
  ...
  render() {
    return h("footer", { key: "b732b9d8c091a9ce1cea4cc9baacb8c2a79d76e0", class: "utrecht-page-footer" }, h("slot", { key: "40293158952052761e4e7e88beac9191158e0627" }));
  }
};
PageFooter.style = UtrechtPageFooterStyle0;
export {
  PageFooter as utrecht_page_footer
};
